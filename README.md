...
docker build --platform linux/amd64 --pull --rm -f "Dockerfile" -t registry.cn-shanghai.aliyuncs.com/perk-ai/one-api:40 . 
docker push registry.cn-shanghai.aliyuncs.com/perk-ai/one-api:40
